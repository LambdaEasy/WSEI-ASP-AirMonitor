...
namespace AirMonitor.Client.Api.Response.Measurement.Definition
{
    ...
    public class MeasurementValueType : IEquatable<MeasurementValueType>
    {
        ...
        public static MeasurementValueType WindSpeed = new MeasurementValueType(MeasurementValueTypeName.WIND_SPEED, "Wind speed", "km/h");
        public static MeasurementValueType WindBearing = new MeasurementValueType(MeasurementValueTypeName.WIND_BEARING, "Wind bearing", "°");
